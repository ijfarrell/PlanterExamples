...
% finite difference scheme for the stiff string/bar
...
B = 0.5; % inharmonicity parameter (>0)
f0 = 200; % fundamental(Hz)
TF = 5; % duration of simulation(s)
ctr = 0.4; wid = 0.3; % center location/width of excitation
u0 = 0; v0 = 1; % maximum initial displacement/velocity
rp = [0.3 0.4]; % positions of readout(0-1)
loss = [100, 4; 1000, 3]; % loss [freq.(Hz), T60(s), freq.(Hz), T60(s)]
% theta = 1  ; % implicit scheme free parameter (>0.5)
theta = ((f0^1.25)/1000) + 0.6;
